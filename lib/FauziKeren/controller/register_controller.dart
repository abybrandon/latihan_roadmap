...
class RegisterController extends GetxController {
  ...
  void registerUser(
    ...
    final newUser =
        RegisterModel(email: email, username: uName, pasw: passWord, paswCon: passConfirmation);
 ...
 final savedUsers = localStorage.read<List>('registeredUsers');
  if (savedUsers != null) {
    registeredUsers.assignAll(savedUsers.map((user) => RegisterModel(
      ...
      for (var user in registeredUsers) {
        print('Email: ${user.email}, Username: ${user.username}, Password: ${user.pasw}, Confirm Password: ${user.paswCon}');
      }
  }
}
